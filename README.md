...
`jackal` server enforces the use of a secured connection, so you'll have to provide at least a private key and a self signed certificate. In order to generate them run the following commands:
