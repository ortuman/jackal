...
type ProcessEventRequest struct {
	...
	//	*ProcessEventRequest_C2SRouterEvInfo
	//	*ProcessEventRequest_S2SStreamEvInfo
	//	*ProcessEventRequest_S2SRouterEvInfo
...
func (x *ProcessEventRequest) GetC2SRouterEvInfo() *C2SRouterEventInfo {
	if x, ok := x.GetPayload().(*ProcessEventRequest_C2SRouterEvInfo); ok {
		return x.C2SRouterEvInfo
	}
	return nil
}
...
func (x *ProcessEventRequest) GetS2SRouterEvInfo() *S2SRouterEventInfo {
	if x, ok := x.GetPayload().(*ProcessEventRequest_S2SRouterEvInfo); ok {
		return x.S2SRouterEvInfo
	}
	return nil
}
...
type ProcessEventRequest_C2SRouterEvInfo struct {
	C2SRouterEvInfo *C2SRouterEventInfo `protobuf:"bytes,4,opt,name=c2s_router_ev_info,json=c2sRouterEvInfo,proto3,oneof"`
}

type ProcessEventRequest_S2SStreamEvInfo struct {
	S2SStreamEvInfo *S2SStreamEventInfo `protobuf:"bytes,5,opt,name=s2s_stream_ev_info,json=s2sStreamEvInfo,proto3,oneof"`
}

type ProcessEventRequest_S2SRouterEvInfo struct {
	S2SRouterEvInfo *S2SRouterEventInfo `protobuf:"bytes,6,opt,name=s2s_router_ev_info,json=s2sRouterEvInfo,proto3,oneof"`
}
...
func (*ProcessEventRequest_C2SRouterEvInfo) isProcessEventRequest_Payload() {}

func (*ProcessEventRequest_S2SStreamEvInfo) isProcessEventRequest_Payload() {}

func (*ProcessEventRequest_S2SRouterEvInfo) isProcessEventRequest_Payload() {}
...
// PreProcessMessageRequest is the parameter message for PreProcessMessage rpc.
type PreProcessMessageRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// message is the incoming message stanza.
	Message *stravaganza.PBElement `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}

func (x *PreProcessMessageRequest) Reset() {
	*x = PreProcessMessageRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PreProcessMessageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PreProcessMessageRequest) ProtoMessage() {}

func (x *PreProcessMessageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_module_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PreProcessMessageRequest.ProtoReflect.Descriptor instead.
func (*PreProcessMessageRequest) Descriptor() ([]byte, []int) {
	return file_module_proto_rawDescGZIP(), []int{10}
}

func (x *PreProcessMessageRequest) GetMessage() *stravaganza.PBElement {
	if x != nil {
		return x.Message
	}
	return nil
...
// PreProcessMessageResponse is the response returned by PreProcessMessage rpc.
type PreProcessMessageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// message is the resulting message stanza.
	Message *stravaganza.PBElement `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}

func (x *PreProcessMessageResponse) Reset() {
	*x = PreProcessMessageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PreProcessMessageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PreProcessMessageResponse) ProtoMessage() {}

func (x *PreProcessMessageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_module_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PreProcessMessageResponse.ProtoReflect.Descriptor instead.
func (*PreProcessMessageResponse) Descriptor() ([]byte, []int) {
	return file_module_proto_rawDescGZIP(), []int{11}
}

func (x *PreProcessMessageResponse) GetMessage() *stravaganza.PBElement {
	if x != nil {
		return x.Message
	}
	return nil
...
// PreRouteMessageRequest is the parameter message for PreRouteMessage rpc.
type PreRouteMessageRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PreRouteMessageRequest) Reset() {
	*x = PreRouteMessageRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PreRouteMessageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PreRouteMessageRequest) ProtoMessage() {}

func (x *PreRouteMessageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_module_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PreRouteMessageRequest.ProtoReflect.Descriptor instead.
func (*PreRouteMessageRequest) Descriptor() ([]byte, []int) {
	return file_module_proto_rawDescGZIP(), []int{12}
}

func (x *PreRouteMessageRequest) GetMessage() *stravaganza.PBElement {
	if x != nil {
		return x.Message
	}
	return nil
...
// PreRouteMessageResponse is the response returned by PreRouteMessage rpc.
type PreRouteMessageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PreRouteMessageResponse) Reset() {
	*x = PreRouteMessageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PreRouteMessageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PreRouteMessageResponse) ProtoMessage() {}

func (x *PreRouteMessageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_module_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PreRouteMessageResponse.ProtoReflect.Descriptor instead.
func (*PreRouteMessageResponse) Descriptor() ([]byte, []int) {
	return file_module_proto_rawDescGZIP(), []int{13}
}

func (x *PreRouteMessageResponse) GetMessage() *stravaganza.PBElement {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *C2SRouterEventInfo) Reset() {
	*x = C2SRouterEventInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *C2SRouterEventInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*C2SRouterEventInfo) ProtoMessage() {}

func (x *C2SRouterEventInfo) ProtoReflect() protoreflect.Message {
	mi := &file_module_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use C2SRouterEventInfo.ProtoReflect.Descriptor instead.
func (*C2SRouterEventInfo) Descriptor() ([]byte, []int) {
	return file_module_proto_rawDescGZIP(), []int{16}
}

func (x *C2SRouterEventInfo) GetTargets() []string {
	if x != nil {
		return x.Targets
	}
	return nil
...
func (x *C2SRouterEventInfo) GetStanza() *stravaganza.PBElement {
	if x != nil {
		return x.Stanza
	}
	return nil
...
func (x *S2SRouterEventInfo) Reset() {
	*x = S2SRouterEventInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *S2SRouterEventInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*S2SRouterEventInfo) ProtoMessage() {}

func (x *S2SRouterEventInfo) ProtoReflect() protoreflect.Message {
	mi := &file_module_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use S2SRouterEventInfo.ProtoReflect.Descriptor instead.
func (*S2SRouterEventInfo) Descriptor() ([]byte, []int) {
	return file_module_proto_rawDescGZIP(), []int{18}
}

func (x *S2SRouterEventInfo) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
func (x *S2SRouterEventInfo) GetStanza() *stravaganza.PBElement {
	if x != nil {
		return x.Stanza
	}
	return nil
...
var file_module_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x22, 0xb3, 0x07, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x63,
	...
	0x57, 0x0a, 0x12, 0x63, 0x32, 0x73, 0x5f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f, 0x65, 0x76,
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6a, 0x61,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x3a, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	0x49, 0x51, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x02, 0x69, 0x71, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x74, 0x72, 0x61, 0x76, 0x61, 0x67, 0x61,
	0x6e, 0x7a, 0x61, 0x2e, 0x50, 0x42, 0x45, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x02, 0x69,
	0x71, 0x22, 0x13, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x49, 0x51, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x4c, 0x0a, 0x18, 0x50, 0x72, 0x65, 0x50, 0x72, 0x6f,
	0x63, 0x65, 0x73, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x61, 0x2e, 0x50, 0x42, 0x45, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x22, 0x4d, 0x0a, 0x19, 0x50, 0x72, 0x65, 0x50, 0x72, 0x6f, 0x63, 0x65,
	...
	0x61, 0x67, 0x65, 0x22, 0x4a, 0x0a, 0x16, 0x50, 0x72, 0x65, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x4d,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_module_proto_goTypes = []interface{}{
	...
	(*PreProcessMessageRequest)(nil),   // 10: jackal.api.module.v1.PreProcessMessageRequest
	(*PreProcessMessageResponse)(nil),  // 11: jackal.api.module.v1.PreProcessMessageResponse
	(*PreRouteMessageRequest)(nil),     // 12: jackal.api.module.v1.PreRouteMessageRequest
	(*PreRouteMessageResponse)(nil),    // 13: jackal.api.module.v1.PreRouteMessageResponse
	(*GetStanzasRequest)(nil),          // 14: jackal.api.module.v1.GetStanzasRequest
	(*C2SStreamEventInfo)(nil),         // 15: jackal.api.module.v1.C2SStreamEventInfo
	(*C2SRouterEventInfo)(nil),         // 16: jackal.api.module.v1.C2SRouterEventInfo
	(*S2SStreamEventInfo)(nil),         // 17: jackal.api.module.v1.S2SStreamEventInfo
	(*S2SRouterEventInfo)(nil),         // 18: jackal.api.module.v1.S2SRouterEventInfo
	(*ExternalComponentEventInfo)(nil), // 19: jackal.api.module.v1.ExternalComponentEventInfo
	(*RosterEventInfo)(nil),            // 20: jackal.api.module.v1.RosterEventInfo
	(*PrivateEventInfo)(nil),           // 21: jackal.api.module.v1.PrivateEventInfo
	(*VCardEventInfo)(nil),             // 22: jackal.api.module.v1.VCardEventInfo
	(*OfflineEventInfo)(nil),           // 23: jackal.api.module.v1.OfflineEventInfo
	(*UserEventInfo)(nil),              // 24: jackal.api.module.v1.UserEventInfo
...
var file_module_proto_depIdxs = []int32{
	...
	15, // 1: jackal.api.module.v1.ProcessEventRequest.c2s_stream_ev_info:type_name -> jackal.api.module.v1.C2SStreamEventInfo
	16, // 2: jackal.api.module.v1.ProcessEventRequest.c2s_router_ev_info:type_name -> jackal.api.module.v1.C2SRouterEventInfo
	17, // 3: jackal.api.module.v1.ProcessEventRequest.s2s_stream_ev_info:type_name -> jackal.api.module.v1.S2SStreamEventInfo
	18, // 4: jackal.api.module.v1.ProcessEventRequest.s2s_router_ev_info:type_name -> jackal.api.module.v1.S2SRouterEventInfo
	19, // 5: jackal.api.module.v1.ProcessEventRequest.ext_component_ev_info:type_name -> jackal.api.module.v1.ExternalComponentEventInfo
	20, // 6: jackal.api.module.v1.ProcessEventRequest.roster_ev_info:type_name -> jackal.api.module.v1.RosterEventInfo
	21, // 7: jackal.api.module.v1.ProcessEventRequest.private_ev_info:type_name -> jackal.api.module.v1.PrivateEventInfo
	22, // 8: jackal.api.module.v1.ProcessEventRequest.vcard_ev_info:type_name -> jackal.api.module.v1.VCardEventInfo
	23, // 9: jackal.api.module.v1.ProcessEventRequest.offline_ev_info:type_name -> jackal.api.module.v1.OfflineEventInfo
	24, // 10: jackal.api.module.v1.ProcessEventRequest.user_ev_info:type_name -> jackal.api.module.v1.UserEventInfo
	25, // 11: jackal.api.module.v1.ProcessIQRequest.iq:type_name -> stravaganza.PBElement
	25, // 12: jackal.api.module.v1.PreProcessMessageRequest.message:type_name -> stravaganza.PBElement
	25, // 13: jackal.api.module.v1.PreProcessMessageResponse.message:type_name -> stravaganza.PBElement
	25, // 14: jackal.api.module.v1.PreRouteMessageRequest.message:type_name -> stravaganza.PBElement
	25, // 15: jackal.api.module.v1.PreRouteMessageResponse.message:type_name -> stravaganza.PBElement
	25, // 16: jackal.api.module.v1.C2SStreamEventInfo.stanza:type_name -> stravaganza.PBElement
	25, // 17: jackal.api.module.v1.C2SRouterEventInfo.stanza:type_name -> stravaganza.PBElement
	25, // 18: jackal.api.module.v1.S2SStreamEventInfo.stanza:type_name -> stravaganza.PBElement
	25, // 19: jackal.api.module.v1.S2SRouterEventInfo.stanza:type_name -> stravaganza.PBElement
	25, // 20: jackal.api.module.v1.ExternalComponentEventInfo.stanza:type_name -> stravaganza.PBElement
	25, // 21: jackal.api.module.v1.PrivateEventInfo.private:type_name -> stravaganza.PBElement
	25, // 22: jackal.api.module.v1.VCardEventInfo.vcard:type_name -> stravaganza.PBElement
	25, // 23: jackal.api.module.v1.OfflineEventInfo.message:type_name -> stravaganza.PBElement
	0,  // 24: jackal.api.module.v1.Module.GetStreamFeature:input_type -> jackal.api.module.v1.GetStreamFeatureRequest
	2,  // 25: jackal.api.module.v1.Module.GetServerFeatures:input_type -> jackal.api.module.v1.GetServerFeaturesRequest
	4,  // 26: jackal.api.module.v1.Module.GetAccountFeatures:input_type -> jackal.api.module.v1.GetAccountFeaturesRequest
	6,  // 27: jackal.api.module.v1.Module.ProcessEvent:input_type -> jackal.api.module.v1.ProcessEventRequest
	8,  // 28: jackal.api.module.v1.Module.ProcessIQ:input_type -> jackal.api.module.v1.ProcessIQRequest
	10, // 29: jackal.api.module.v1.Module.PreProcessMessage:input_type -> jackal.api.module.v1.PreProcessMessageRequest
	12, // 30: jackal.api.module.v1.Module.PreRouteMessage:input_type -> jackal.api.module.v1.PreRouteMessageRequest
	14, // 31: jackal.api.module.v1.Module.GetStanzas:input_type -> jackal.api.module.v1.GetStanzasRequest
	1,  // 32: jackal.api.module.v1.Module.GetStreamFeature:output_type -> jackal.api.module.v1.GetStreamFeatureResponse
	3,  // 33: jackal.api.module.v1.Module.GetServerFeatures:output_type -> jackal.api.module.v1.GetServerFeaturesResponse
	5,  // 34: jackal.api.module.v1.Module.GetAccountFeatures:output_type -> jackal.api.module.v1.GetAccountFeaturesResponse
	7,  // 35: jackal.api.module.v1.Module.ProcessEvent:output_type -> jackal.api.module.v1.ProcessEventResponse
	9,  // 36: jackal.api.module.v1.Module.ProcessIQ:output_type -> jackal.api.module.v1.ProcessIQResponse
	11, // 37: jackal.api.module.v1.Module.PreProcessMessage:output_type -> jackal.api.module.v1.PreProcessMessageResponse
	13, // 38: jackal.api.module.v1.Module.PreRouteMessage:output_type -> jackal.api.module.v1.PreRouteMessageResponse
	25, // 39: jackal.api.module.v1.Module.GetStanzas:output_type -> stravaganza.PBElement
...
func file_module_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_module_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PreProcessMessageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_module_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PreProcessMessageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_module_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PreRouteMessageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_module_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PreRouteMessageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_module_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*C2SRouterEventInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_module_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*S2SRouterEventInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_module_proto_msgTypes[6].OneofWrappers = []interface{}{
		...
		(*ProcessEventRequest_C2SRouterEvInfo)(nil),
		(*ProcessEventRequest_S2SStreamEvInfo)(nil),
		(*ProcessEventRequest_S2SRouterEvInfo)(nil),
...
type ModuleClient interface {
	...
	// PreProcessMessage will be invoked by server upon receiving a message stanza over a C2S stream.
	PreProcessMessage(ctx context.Context, in *PreProcessMessageRequest, opts ...grpc.CallOption) (*PreProcessMessageResponse, error)
	// PreRouteMessage will be invoked by server before routing a message stanza over a C2S stream.
	PreRouteMessage(ctx context.Context, in *PreRouteMessageRequest, opts ...grpc.CallOption) (*PreRouteMessageResponse, error)
...
func (c *moduleClient) PreProcessMessage(ctx context.Context, in *PreProcessMessageRequest, opts ...grpc.CallOption) (*PreProcessMessageResponse, error) {
	out := new(PreProcessMessageResponse)
	err := c.cc.Invoke(ctx, "/jackal.api.module.v1.Module/PreProcessMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *moduleClient) PreRouteMessage(ctx context.Context, in *PreRouteMessageRequest, opts ...grpc.CallOption) (*PreRouteMessageResponse, error) {
	out := new(PreRouteMessageResponse)
	err := c.cc.Invoke(ctx, "/jackal.api.module.v1.Module/PreRouteMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ModuleServer interface {
	...
	// PreProcessMessage will be invoked by server upon receiving a message stanza over a C2S stream.
	PreProcessMessage(context.Context, *PreProcessMessageRequest) (*PreProcessMessageResponse, error)
	// PreRouteMessage will be invoked by server before routing a message stanza over a C2S stream.
	PreRouteMessage(context.Context, *PreRouteMessageRequest) (*PreRouteMessageResponse, error)
	// GetStanzas returns a stream of stanzas to be routed by server.
...
func (*UnimplementedModuleServer) PreProcessMessage(context.Context, *PreProcessMessageRequest) (*PreProcessMessageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PreProcessMessage not implemented")
}
func (*UnimplementedModuleServer) PreRouteMessage(context.Context, *PreRouteMessageRequest) (*PreRouteMessageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PreRouteMessage not implemented")
}
...
func _Module_PreProcessMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PreProcessMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ModuleServer).PreProcessMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jackal.api.module.v1.Module/PreProcessMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ModuleServer).PreProcessMessage(ctx, req.(*PreProcessMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Module_PreRouteMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PreRouteMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ModuleServer).PreRouteMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jackal.api.module.v1.Module/PreRouteMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ModuleServer).PreRouteMessage(ctx, req.(*PreRouteMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Module_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PreProcessMessage",
			Handler:    _Module_PreProcessMessage_Handler,
		},
		{
			MethodName: "PreRouteMessage",
			Handler:    _Module_PreRouteMessage_Handler,
		},
	},
