...
func TestRoster_UpdateItem(t *testing.T) {
	...
	resMngMock.GetResourcesFunc = func(ctx context.Context, username string) ([]model.Resource, error) {
		return []model.Resource{
			{JID: jd0, InstanceID: "i0", Context: map[string]string{rosterRequestedCtxKey: "1"}},
...
func TestRoster_Subscribed(t *testing.T) {
	...
	resMngMock.GetResourcesFunc = func(ctx context.Context, username string) ([]model.Resource, error) {
		...
		case username == "ortuman":
			return []model.Resource{
				{JID: jd0, InstanceID: "i1", Context: map[string]string{rosterRequestedCtxKey: "1"}},
			}, nil
		case username == "noelia":
			return []model.Resource{
				{JID: jd1, InstanceID: "i1", Context: map[string]string{rosterRequestedCtxKey: "1"}},
			}, nil
		}
		return nil, nil
	}
			...
			return []model.Resource{
				{
					...
					Context:    map[string]string{rosterRequestedCtxKey: "1"},
				},
			}, nil
		}
		return nil, nil
