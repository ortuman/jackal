...
func (m *measuredBlockListRep) UpsertBlockListItem(ctx context.Context, item *model.BlockListItem) (err error) {
	t0 := time.Now()
...
func (m *measuredBlockListRep) DeleteBlockListItem(ctx context.Context, item *model.BlockListItem) (err error) {
	t0 := time.Now()
...
func (m *measuredBlockListRep) FetchBlockListItems(ctx context.Context, username string) (blockList []model.BlockListItem, err error) {
	t0 := time.Now()
