...
// GetStreamQueueRequest is the parameter message for StreamManager GetStreamQueue rpc.
type GetStreamQueueRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// ssid is the unique stream session identifier.
	Ssid string `protobuf:"bytes,1,opt,name=ssid,proto3" json:"ssid,omitempty"`
}

func (x *GetStreamQueueRequest) Reset() {
	*x = GetStreamQueueRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetStreamQueueRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStreamQueueRequest) ProtoMessage() {}

func (x *GetStreamQueueRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cluster_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetStreamQueueRequest.ProtoReflect.Descriptor instead.
func (*GetStreamQueueRequest) Descriptor() ([]byte, []int) {
	return file_cluster_proto_rawDescGZIP(), []int{6}
}

func (x *GetStreamQueueRequest) GetSsid() string {
	if x != nil {
		return x.Ssid
	}
	return ""
...
// GetStreamQueueResponse is the response returned by StreamManager GetStreamQueue rpc.
type GetStreamQueueResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// stanza contains all resumed session queued stanzas.
	StanzaQueue []*stravaganza.PBElement `protobuf:"bytes,1,rep,name=stanza_queue,json=stanzaQueue,proto3" json:"stanza_queue,omitempty"`
}

func (x *GetStreamQueueResponse) Reset() {
	*x = GetStreamQueueResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetStreamQueueResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStreamQueueResponse) ProtoMessage() {}

func (x *GetStreamQueueResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cluster_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetStreamQueueResponse.ProtoReflect.Descriptor instead.
func (*GetStreamQueueResponse) Descriptor() ([]byte, []int) {
	return file_cluster_proto_rawDescGZIP(), []int{7}
}

func (x *GetStreamQueueResponse) GetStanzaQueue() []*stravaganza.PBElement {
	if x != nil {
		return x.StanzaQueue
	}
	return nil
}

// DeleteStreamQueue is the parameter message for StreamManager DeleteStreamQueue rpc.
type DeleteStreamQueueRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DeleteStreamQueueRequest) Reset() {
	*x = DeleteStreamQueueRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeleteStreamQueueRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteStreamQueueRequest) ProtoMessage() {}

func (x *DeleteStreamQueueRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cluster_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteStreamQueueRequest.ProtoReflect.Descriptor instead.
func (*DeleteStreamQueueRequest) Descriptor() ([]byte, []int) {
	return file_cluster_proto_rawDescGZIP(), []int{8}
}

func (x *DeleteStreamQueueRequest) GetSsid() string {
	if x != nil {
		return x.Ssid
	}
	return ""
...
// DeleteStreamQueueResponse is the response returned by StreamManager DeleteStreamQueue rpc.
type DeleteStreamQueueResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *DeleteStreamQueueResponse) Reset() {
	*x = DeleteStreamQueueResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeleteStreamQueueResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteStreamQueueResponse) ProtoMessage() {}

func (x *DeleteStreamQueueResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cluster_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteStreamQueueResponse.ProtoReflect.Descriptor instead.
func (*DeleteStreamQueueResponse) Descriptor() ([]byte, []int) {
...
var file_cluster_proto_rawDesc = []byte{
	...
	,
	...
	0x46, 0x0a, 0x12, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6c,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_cluster_proto_goTypes = []interface{}{
	...
	(*GetStreamQueueRequest)(nil),     // 7: cluster.v1.GetStreamQueueRequest
	(*GetStreamQueueResponse)(nil),    // 8: cluster.v1.GetStreamQueueResponse
	(*DeleteStreamQueueRequest)(nil),  // 9: cluster.v1.DeleteStreamQueueRequest
	(*DeleteStreamQueueResponse)(nil), // 10: cluster.v1.DeleteStreamQueueResponse
	(*StreamError)(nil),               // 11: cluster.v1.StreamError
	(*stravaganza.PBElement)(nil),     // 12: stravaganza.PBElement
}
var file_cluster_proto_depIdxs = []int32{
	12, // 0: cluster.v1.LocalRouteRequest.stanza:type_name -> stravaganza.PBElement
	11, // 1: cluster.v1.LocalDisconnectRequest.stream_error:type_name -> cluster.v1.StreamError
	12, // 2: cluster.v1.ComponentRouteRequest.stanza:type_name -> stravaganza.PBElement
	12, // 3: cluster.v1.GetStreamQueueResponse.stanza_queue:type_name -> stravaganza.PBElement
	0,  // 4: cluster.v1.StreamError.reason:type_name -> cluster.v1.StreamErrorReason
	12, // 5: cluster.v1.StreamError.applicationElement:type_name -> stravaganza.PBElement
	1,  // 6: cluster.v1.LocalRouter.Route:input_type -> cluster.v1.LocalRouteRequest
	3,  // 7: cluster.v1.LocalRouter.Disconnect:input_type -> cluster.v1.LocalDisconnectRequest
	5,  // 8: cluster.v1.ComponentRouter.Route:input_type -> cluster.v1.ComponentRouteRequest
	7,  // 9: cluster.v1.StreamManager.GetStreamQueue:input_type -> cluster.v1.GetStreamQueueRequest
	9,  // 10: cluster.v1.StreamManager.DeleteStreamQueue:input_type -> cluster.v1.DeleteStreamQueueRequest
	...
	8,  // 14: cluster.v1.StreamManager.GetStreamQueue:output_type -> cluster.v1.GetStreamQueueResponse
	10, // 15: cluster.v1.StreamManager.DeleteStreamQueue:output_type -> cluster.v1.DeleteStreamQueueResponse
...
func file_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cluster_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetStreamQueueRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cluster_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetStreamQueueResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cluster_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteStreamQueueRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cluster_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteStreamQueueResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type StreamManagerClient interface {
	// GetStreamQueue returns stream managed in memory queue.
	GetStreamQueue(ctx context.Context, in *GetStreamQueueRequest, opts ...grpc.CallOption) (*GetStreamQueueResponse, error)
	// DeleteStreamQueue removes a stream managed in memory queue.
	DeleteStreamQueue(ctx context.Context, in *DeleteStreamQueueRequest, opts ...grpc.CallOption) (*DeleteStreamQueueResponse, error)
}
...
func (c *streamManagerClient) GetStreamQueue(ctx context.Context, in *GetStreamQueueRequest, opts ...grpc.CallOption) (*GetStreamQueueResponse, error) {
	out := new(GetStreamQueueResponse)
	err := c.cc.Invoke(ctx, "/cluster.v1.StreamManager/GetStreamQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamManagerClient) DeleteStreamQueue(ctx context.Context, in *DeleteStreamQueueRequest, opts ...grpc.CallOption) (*DeleteStreamQueueResponse, error) {
	out := new(DeleteStreamQueueResponse)
	err := c.cc.Invoke(ctx, "/cluster.v1.StreamManager/DeleteStreamQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StreamManagerServer interface {
	// GetStreamQueue returns stream managed in memory queue.
	GetStreamQueue(context.Context, *GetStreamQueueRequest) (*GetStreamQueueResponse, error)
	// DeleteStreamQueue removes a stream managed in memory queue.
	DeleteStreamQueue(context.Context, *DeleteStreamQueueRequest) (*DeleteStreamQueueResponse, error)
}
...
func (*UnimplementedStreamManagerServer) GetStreamQueue(context.Context, *GetStreamQueueRequest) (*GetStreamQueueResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStreamQueue not implemented")
}
func (*UnimplementedStreamManagerServer) DeleteStreamQueue(context.Context, *DeleteStreamQueueRequest) (*DeleteStreamQueueResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteStreamQueue not implemented")
}
...
func _StreamManager_GetStreamQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStreamQueueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamManagerServer).GetStreamQueue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cluster.v1.StreamManager/GetStreamQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamManagerServer).GetStreamQueue(ctx, req.(*GetStreamQueueRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamManager_DeleteStreamQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteStreamQueueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamManagerServer).DeleteStreamQueue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cluster.v1.StreamManager/DeleteStreamQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamManagerServer).DeleteStreamQueue(ctx, req.(*DeleteStreamQueueRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _StreamManager_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cluster.v1.StreamManager",
	HandlerType: (*StreamManagerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetStreamQueue",
			Handler:    _StreamManager_GetStreamQueue_Handler,
		},
		{
			MethodName: "DeleteStreamQueue",
			Handler:    _StreamManager_DeleteStreamQueue_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cluster.proto",
