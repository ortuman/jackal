...
func TestMySQLStorageInsertOccupant(t *testing.T) {
	...
	mock.ExpectBegin()
	mock.ExpectExec("INSERT INTO occupants (.+) ON DUPLICATE KEY UPDATE (.+)").
		WithArgs(o.OccupantJID.String(), o.BareJID.String(), o.GetAffiliation(), o.GetRole(),
			o.GetAffiliation(), o.GetRole()).
		WillReturnResult(sqlmock.NewResult(1, 1))
	mock.ExpectExec("INSERT INTO resources (.+) ON DUPLICATE KEY UPDATE (.+)").
		WithArgs(o.OccupantJID.String(), "yard", "yard").
		WillReturnResult(sqlmock.NewResult(1, 1))
	mock.ExpectCommit()
...
func TestMySQLStorageDeleteOccupant(t *testing.T) {
	j, _ := jid.NewWithString("room@conference.jackal.im/nick", true)
	s, mock := newOccupantMock()
	mock.ExpectBegin()
...
func TestMySQLStorageFetchOccupant(t *testing.T) {
	j, _ := jid.NewWithString("room@conference.jackal.im/nick", true)
...
func TestMySQLStorageOccupantExists(t *testing.T) {
	j, _ := jid.NewWithString("room@conference.jackal.im/nick", true)
...
func newOccupantMock() (*mySQLOccupant, sqlmock.Sqlmock) {
