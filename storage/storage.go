...
type Storage interface {
	...
	InsertOrUpdateVCard(vCard xml.ElementNode, username string) error
	FetchVCard(username string) (xml.ElementNode, error)

	FetchPrivateXML(namespace string, username string) ([]xml.ElementNode, error)
	InsertOrUpdatePrivateXML(privateXML []xml.ElementNode, namespace string, username string) error

	InsertOfflineMessage(message xml.ElementNode, username string) error
	CountOfflineMessages(username string) (int, error)
	FetchOfflineMessages(username string) ([]xml.ElementNode, error)
