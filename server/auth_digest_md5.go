...
func (d *digestMD5Authenticator) ProcessElement(elem xml.ElementNode) error {
	if d.Authenticated() {
		return nil
	}
	switch elem.Name() {
...
func (d *digestMD5Authenticator) handleStart(elem xml.ElementNode) error {
...
func (d *digestMD5Authenticator) handleChallenged(elem xml.ElementNode) error {
	if len(elem.Text()) == 0 {
...
func (d *digestMD5Authenticator) handleAuthenticated(elem xml.ElementNode) error {
